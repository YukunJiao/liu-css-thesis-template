...
=
\boldsymbol{\alpha}
+ \boldsymbol{\beta}_1 \, \mathrm{Mid}_i
+ \boldsymbol{\beta}_2 \, \mathrm{Late}_i
+ \boldsymbol{\gamma} \, \mathrm{doc\_length\_bin}_i
...
\mathbf{d}
=
\frac{\mathbf{c}_B - \mathbf{c}_A}
{\sqrt{(\mathbf{c}_B - \mathbf{c}_A)^\top(\mathbf{c}_B - \mathbf{c}_A)}}
$$
