...
function Meta(meta)
  ...
  table.insert(lines, "")
  table.insert(lines, "\\usepackage[backend=biber,style=numeric,sorting=none,hyperref]{biblatex}")
  table.insert(lines, "")
  ...
  table.insert(lines, "")
  table.insert(lines, "\\ExecuteBibliographyOptions{maxnames=99}")
  table.insert(lines, "\\ExecuteBibliographyOptions{maxcitenames=2}")
  table.insert(lines, "")
  table.insert(lines, "\\addbibresource{references.bib}")
  table.insert(lines, "")
